...
@Component({
  selector: 'app-employee-profile2',
  templateUrl: './employee-profile2.component.html',
  styleUrls: ['./employee-profile2.component.scss']
})
export class EmployeeProfile2Component implements OnInit {
  ...
  async Save_Hr_employee_profile_data () {
    ...
    (this.hdr_HR_employee_Info_Data.empdepartment = this.hdr_HR_Employee_Info_form?.controls['empdepartment'].value);
